        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-primary-cream to-primary-gray rounded-3xl h-96 flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="text-center text-primary-brown transform -rotate-3">
                  ...
                  <p className="text-brown-600 text-lg">Sejak 2010</p>
                </div>
              </div>
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="bg-primary-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 text-center"
                >
                  ...
                  <h3 className="text-xl font-bold text-primary-brown mb-3">{value.title}</h3>
                ...
                >
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                    <div className="bg-primary-white rounded-2xl p-6 shadow-lg border border-primary-gray/10">
                      <div className="text-2xl font-bold text-primary-brown mb-2">{milestone.year}</div>
                      <h3 className="text-xl font-semibold text-primary-brown mb-3">{milestone.title}</h3>
                      <p className="text-brown-600">{milestone.description}</p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <motion.div
                ...
                className="bg-primary-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 text-center"
              >
                <div className="w-20 h-20 bg-gradient-to-br from-primary-brown to-brown-800 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-3xl">{member.avatar}</span>
                </div>
                <h3 className="text-xl font-bold text-primary-brown mb-1">{member.name}</h3>
                <p className="text-primary-brown font-medium mb-3">{member.role}</p>
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="text-center p-6 bg-primary-white rounded-2xl shadow-lg border border-primary-gray/10"
                >
                  <Icon className="mx-auto mb-3 text-primary-brown" size={32} />
                  <div className="text-3xl font-bold text-primary-brown mb-2">{stat.value}</div>
